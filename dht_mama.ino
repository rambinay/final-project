...
#define DHTPIN 8                      // Digital Pin 5

#define DHTTYPE DHT11                  // We are Using DHT11

String apiKey = "5VXRXXVO136F26KA";    // Edit this API key according to your Account

String Host_Name = "Low Speed Mode";         // Edit Host_Name

String Password = "ASD135xxx0";          // Edit Password
